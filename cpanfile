...
requires 'Mojolicious::Plugin::Fondation::Auth'                  => '0.01';
...
requires 'Mojolicious::Plugin::Fondation::Group::UI::Bootstrap'  => '0.01';
requires 'Mojolicious::Plugin::Fondation::Perm'                  => '0.01';
requires 'Mojolicious::Plugin::Fondation::Perm::UI::Bootstrap'   => '0.01';
